    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="carta-dificultad p-3 animate__animated animate__zoomInUp">
            ...
            <div class="contenido-dificultad">
                <div class="contenedor-titulo texto-facil p-2">
                    <h4>DIFICULTAD</h4>
                </div>
                <div class="contenedor-dificultad p-2">
                    <div class="marco-imagen-dificultad dificultad-facil p-1">
                        <img class="img-fluid" src="../../assets/img/Recursos/Dificultad Facil.png" alt="imagenDificultad">
                    </div>
                </div>
                <div class="contenedor-descripcion p-2">
                    <div class="contenedor-numero-elementos p-1">
                        <h4 class="palabra texto-facil">ELEMENTOS</h4>
