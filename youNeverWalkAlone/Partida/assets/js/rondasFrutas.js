...
function avanzarNivel() {
    ...
    if (nuevoNivel !== 'completado') {
        ...
        if(nuevoNivel === 'medio'){
            window.location.href = 'Categoria_Frutas/Memorizacion Medio.html';//aca van los html que describen la dificultad para el aumento de nivel
        }
        else if(nuevoNivel === 'dificil'){
        window.location.href = 'Categoria_Frutas/Memorizacion Dificil.html';//aca van los html que describen la dificultad para el aumento de nivel
    }
    }else {
